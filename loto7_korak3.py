#!/usr/bin/env python3
"""Korak 3 — + ograničenje fuzije → loto7_korak3.txt"""
...
def main() -> None:
    p = argparse.ArgumentParser(description="Korak 3")
    ...
    eng = Loto7Engine(kola, korak=3, seed=args.seed)
    combo, sc = eng.najbolja(preth=poslednje_kolo(kola), max_pokusaja=args.pokusaja)
    out = upisi_predikciju(3, kola, combo, sc, args.csv)
    print(f"Korak 3 → {out}")
...
"""
Loto 7/39 — KORAK 3
Korak 2 + ograničenje fuzije (5 strategija)
Generisano: 23.06.2026 10:59
